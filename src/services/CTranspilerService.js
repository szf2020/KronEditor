...
export const transpileToC = (projectStructure, standardHeaders = [], boardId = null) => {
    let stdFunctions = {};
    let customIncludes = ``;
    ...
    if (boardId) {
        ...
        if (familyDef) boardDefines += `#define ${familyDef} 1\n`;
...
`;
    ...
    source += generateMainLoop(projectStructure, config, boardId);
...
const generateMainLoop = (projectStructure, config, boardId = null) => {
